...
| analytic hypergradient (§6) vs. full automatic differentiation (§7a) | relative error \(\le10^{-9}\); absolute \(\le10^{-11}\) if reference norm \(\le10^{-10}\) |
